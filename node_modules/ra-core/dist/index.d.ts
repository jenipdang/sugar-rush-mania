 ...
 *                    \-- data is Product
 */
declare const useCreate: <RecordType extends RaRecord = any, MutationError = unknown>(resource?: string, params?: Partial<CreateParams<Partial<RecordType>>>, options?: UseCreateOptions<RecordType, MutationError>) => UseCreateResult<RecordType, boolean, MutationError>;
interface UseCreateMutateParams<RecordType extends RaRecord = any> {
    resource?: string;
    data?: Partial<RecordType>;
    meta?: any;
}
declare type UseCreateOptions<RecordType extends RaRecord = any, MutationError = unknown> = UseMutationOptions<RecordType, MutationError, Partial<UseCreateMutateParams<RecordType>>>;
declare type UseCreateResult<RecordType extends RaRecord = any, TReturnPromise extends boolean = boolean, MutationError = unknown> = [
 ...
 *                    \-- data is Product
 */
declare const useUpdate: <RecordType extends RaRecord = any, MutationError = unknown>(resource?: string, params?: Partial<UpdateParams<RecordType>>, options?: UseUpdateOptions<RecordType, MutationError>) => UseUpdateResult<RecordType, boolean, MutationError>;
...
declare type UseUpdateOptions<RecordType extends RaRecord = any, MutationError = unknown> = UseMutationOptions<RecordType, MutationError, Partial<UseUpdateMutateParams<RecordType>>> & {
    mutationMode?: MutationMode;
};
declare type UseUpdateResult<RecordType extends RaRecord = any, TReturnPromise extends boolean = boolean, MutationError = unknown> = [
 ...
 * };
 */
declare const useUpdateMany: <RecordType extends RaRecord = any, MutationError = unknown>(resource?: string, params?: Partial<UpdateManyParams<Partial<RecordType>>>, options?: UseUpdateManyOptions<RecordType, MutationError>) => UseUpdateManyResult<RecordType, boolean, MutationError>;
...
declare type UseUpdateManyOptions<RecordType extends RaRecord = any, MutationError = unknown> = UseMutationOptions<Array<RecordType['id']>, MutationError, Partial<UseUpdateManyMutateParams<RecordType>>> & {
    mutationMode?: MutationMode;
};
declare type UseUpdateManyResult<RecordType extends RaRecord = any, TReturnPromise extends boolean = boolean, MutationError = unknown> = [
 ...
 *                    \-- data is Product
 */
declare const useDelete: <RecordType extends RaRecord = any, MutationError = unknown>(resource?: string, params?: Partial<DeleteParams<RecordType>>, options?: UseDeleteOptions<RecordType, MutationError>) => UseDeleteResult<RecordType, MutationError>;
...
declare type UseDeleteOptions<RecordType extends RaRecord = any, MutationError = unknown> = UseMutationOptions<RecordType, MutationError, Partial<UseDeleteMutateParams<RecordType>>> & {
    mutationMode?: MutationMode;
};
declare type UseDeleteResult<RecordType extends RaRecord = any, MutationError = unknown> = [
 ...
 *                        \-- data is Product
 */
declare const useDeleteMany: <RecordType extends RaRecord = any, MutationError = unknown>(resource?: string, params?: Partial<DeleteManyParams<RecordType>>, options?: UseDeleteManyOptions<RecordType, MutationError>) => UseDeleteManyResult<RecordType, MutationError>;
interface UseDeleteManyMutateParams<RecordType extends RaRecord = any> {
    resource?: string;
    ids?: RecordType['id'][];
    meta?: any;
}
declare type UseDeleteManyOptions<RecordType extends RaRecord = any, MutationError = unknown> = UseMutationOptions<RecordType['id'][], MutationError, Partial<UseDeleteManyMutateParams<RecordType>>> & {
    mutationMode?: MutationMode;
};
declare type UseDeleteManyResult<RecordType extends RaRecord = any, MutationError = unknown> = [
...
interface UseDeleteWithUndoControllerParams<RecordType extends RaRecord = any, MutationOptionsError = unknown> {
    record?: RecordType;
...
interface UseDeleteWithConfirmControllerParams<RecordType extends RaRecord = any, MutationOptionsError = unknown> {
    mutationMode?: MutationMode;
    record?: RecordType;
    redirect?: RedirectionSideEffect;
    resource?: string;
 ...
 * }
 */
declare const useCreateController: <RecordType extends RaRecord = RaRecord, MutationOptionsError = unknown>(props?: CreateControllerProps<RecordType, MutationOptionsError>) => CreateControllerResult<RecordType>;
interface CreateControllerProps<RecordType extends RaRecord = RaRecord, MutationOptionsError = unknown> {
 ...
 * );
 */
declare const CreateBase: <RecordType extends RaRecord = any>({ children, ...props }: CreateControllerProps<RecordType, unknown> & {
    children: ReactNode;
}) => JSX.Element;
...
} & CreateControllerProps<RaRecord, unknown>) => JSX.Element;
 ...
 * }
 */
declare const useEditController: <RecordType extends RaRecord = any, MutationOptionsError = unknown>(props?: EditControllerProps<RecordType, MutationOptionsError>) => EditControllerResult<RecordType>;
interface EditControllerProps<RecordType extends RaRecord = any, MutationOptionsError = unknown> {
    disableAuthentication?: boolean;
    id?: RecordType['id'];
    mutationMode?: MutationMode;
