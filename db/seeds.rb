...
p5 = Product.create!(user_id: jeni.id, name: "Creme Brulee", price: "8.50", description: "Available Flavors: Vanilla, Chocolate, Lemon, Green Tea, and Ube", category: "Cake").image.attach(io: File.open('/Users/jenidang/Development/code/Phase5/SRM_Images/ube_creme_burle.png'), filename: 'ube_creme_burle.png') 
